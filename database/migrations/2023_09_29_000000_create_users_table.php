...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Schema::table('users', function(Blueprint $table) {
            // $table->foreign('role_id')->on('admin_roles')->references('id');
            // alter table `users` add constraint `users_role_id_foreign` foreign key (`role_id`) references `admin_roles` (`id`)
        // });
    }
